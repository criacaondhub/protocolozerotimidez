...
const careerPoints = [
    <>A promoção que foi para o colega que <br className="hidden lg:block" /> <span className="font-semibold">"sabe se vender"</span>;</>,
    <>A ideia que você não apresentou e <br className="hidden lg:block" /> <span className="font-semibold">outro levou o crédito</span>;</>,
    <>Oportunidades que passaram porque <br className="hidden lg:block" /> <span className="font-semibold">não se posicionou</span>;</>,
    ...
    <>O arrependimento de ver outras pessoas <br className="hidden lg:block" /> <span className="font-semibold">brilhando</span> enquanto você fica na sombra.</>
];

const relationshipsPoints = [
    <>Conexões que você não fez por medo <br className="hidden lg:block" /> <span className="font-semibold">medo de puxar conversa</span>;</>,
    <>Ser <span className="font-semibold">excluído de grupos</span> e deixar de ser <br className="hidden lg:block" /> convidado para eventos;</>,
    <>Amizades que não aconteceram porque <br className="hidden lg:block" /> você <span className="font-semibold">não sabia o que dizer</span>;</>,
    <>Momentos que você evitou por medo <br className="hidden lg:block" /> de <span className="font-semibold">ser julgado</span>;</>,
    <>A frustração de voltar para casa pensando <br className="hidden lg:block" /> <span className="font-semibold">"eu deveria ter falado"</span>;</>,
        ...
        <section className="bg-white text-black py-24 relative overflow-hidden min-h-screen flex flex-col justify-center">
            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-7xl mx-auto">
                    ...
                    >
                        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 mb-8 text-center lg:text-left">
                        ...
                        <ul className="space-y-6 flex flex-col items-center lg:items-start text-center lg:text-left">
                            {careerPoints.map((point, idx) => (
                                <li key={idx} className="flex flex-row items-start text-lg md:text-[1.25rem] text-zinc-700 leading-snug text-left">
